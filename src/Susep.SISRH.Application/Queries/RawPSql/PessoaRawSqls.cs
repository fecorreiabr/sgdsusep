        ...
        public static string ObterDashboard
        {
            get
            {
                return @"
                        ...
                        --Planos ""n√""£o ""encerrados"" ""nas"" ""unidades"" ""em"" ""que"" a ""pessoa"" √© ""chefe"":
						...
						-- ""Planos"" ""em"" ""execu√""ß√£o ""que"" o ""servidor"" ""foi"" ""selecionado""
						...
						UNION
						-- ""Planos"" ""em"" ""habilita√""ß√£o na(s) ""unidades"" ""do"" ""servidor""
						SELECT   p.""planoTrabalhoId""
                                ,""u1"".""undSiglaCompleta"" ""unidade""  
                                ,p.""dataInicio""    
                                ,p.""dataFim""
